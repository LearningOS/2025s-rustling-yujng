...
#[no_mangle]
#[link_name = "my_demo_function"]  // 将别名链接到 my_demo_function
...
mod tests {
    ...
    fn test_success() {
        ...
        // Rust function.
        unsafe {
            assert_eq!(my_demo_function(123), 123);  // Test the original function
            assert_eq!(my_demo_function_alias(456), 456);  // Test the alias
        }
    }
}
